...
namespace mu2e {
  struct TrkCaloHitSeed {
    ...
    TrkCaloHitSeed(HitT0 const& t0, Float_t trklen, Float_t hitlen, Float_t cdoca, Float_t rerr,StrawHitFlag const& flag) :
      _t0(t0), _trklen(trklen), _hitlen(hitlen), _cdoca(cdoca), _rerr(rerr), _flag(flag)
    {}
    // accessors
