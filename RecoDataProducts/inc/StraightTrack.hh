...
namespace mu2e {
  ...
  public:
    ...
    StraightTrack(int dim, int N, double c_0, double c_0_err, double m_0, double m_0_err, double m_1, double m_1_err, double m_2, double m_2_err, double chisq, double chisq_dof);
    ...
    //For XYZ m1 and c1 exist else it is just 0:
...
double element){ _cov_mat[r][c] = element;}
    ...
    void set_parameters(int dim, int N, double c_0, double c_0_err, double m_0, double m_0_err,double m_1, double m_1_err, double m_2, double m_2_err, double chisq, double chisq_dof, std::vector<double> _fit_residual, std::vector<double> _fit_residual_error);
