...
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_6000_0"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_T.fcl
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_6000_1"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_TS.fcl
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_5000_-1"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_E.fcl
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_4550_0"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_R.fcl
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_4550_0"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_L.fcl
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_6900_1"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_U.fcl
sed -i '666s/.*/physics.producers.CrvPhotons.lookupTableFileNames : ["CRVConditions\/v4_1\/LookupTable_5700_0"]/' CRVResponse/efficiencyCheck/submit/CRV_Efficiency_check_D.fcl
...
#do
    ...
    do
        ...
        dx=`echo "820.8+$moduleGap+7*$gapLarge+8*$gapSmall" | bc -l`
        dy=`echo "820.8+$moduleGap+7*$gapLarge+8*$gapSmall" | bc -l`
        dz=`echo "820.8+$moduleGap+7*$gapLarge+8*$gapSmall" | bc -l`
        ...
        generate_fcl --description=$name --dsconf=$i --run=1 --events=100000 --njobs=20 $fclfile
