...
namespace mu2e {
  ...
  public:
    ...
    STM_SSC(bool build, double delta_WlR, double delta_WlL, double W_length, 
                 double W_height, double leak, double Wdepth_f, double Wdepth_b,
    ...
    double W_length()    const {return _W_length;}
