//Code generated automatically by TMVA for Inference of Model file [TrainBkgDiagStationSpatialSLine.h5] at [Fri Feb 23 16:24:00 2024] 

#ifndef TMVA_SOFIE_TRAINBKGDIAGSTATIONSPATIALSLINE
#define TMVA_SOFIE_TRAINBKGDIAGSTATIONSPATIALSLINE
...
namespace TMVA_SOFIE_TrainBkgDiagStationSpatialSLine{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "TrainBkgDiagStationSpatialSLine.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_TrainBkgDiagStationSpatialSLine

#endif  // TMVA_SOFIE_TRAINBKGDIAGSTATIONSPATIALSLINE
