//Code generated automatically by TMVA for Inference of Model file [TrainBkgDiag.h5] at [Mon Mar  9 22:45:42 2026] 
...
std::vector<float> fTensor_dense2bias0 = std::vector<float>(16);
...
std::vector<float> fTensor_dense1kernel0 = std::vector<float>(256);
float * tensor_dense1kernel0 = fTensor_dense1kernel0.data();
std::vector<float> fTensor_densebias0 = std::vector<float>(16);
float * tensor_densebias0 = fTensor_densebias0.data();
std::vector<float> fTensor_dense3kernel0 = std::vector<float>(16);
float * tensor_dense3kernel0 = fTensor_dense3kernel0.data();
std::vector<float> fTensor_dense2kernel0 = std::vector<float>(256);
float * tensor_dense2kernel0 = fTensor_dense2kernel0.data();
std::vector<float> fTensor_densekernel0 = std::vector<float>(128);
...
std::vector<float> fTensor_denseDense = std::vector<float>(16);
...
std::vector<float> fTensor_dense2Dense = std::vector<float>(16);
float * tensor_dense2Dense = fTensor_dense2Dense.data();
std::vector<float> fTensor_dense1Dense = std::vector<float>(16);
float * tensor_dense1Dense = fTensor_dense1Dense.data();
std::vector<float> fTensor_denseRelu0 = std::vector<float>(16);
float * tensor_denseRelu0 = fTensor_denseRelu0.data();
std::vector<float> fTensor_dense1bias0bcast = std::vector<float>(16);
float * tensor_dense1bias0bcast = fTensor_dense1bias0bcast.data();
std::vector<float> fTensor_densebias0bcast = std::vector<float>(16);
float * tensor_densebias0bcast = fTensor_densebias0bcast.data();
std::vector<float> fTensor_dense2bias0bcast = std::vector<float>(16);
float * tensor_dense2bias0bcast = fTensor_dense2bias0bcast.data();
std::vector<float> fTensor_dense2Relu0 = std::vector<float>(16);
float * tensor_dense2Relu0 = fTensor_dense2Relu0.data();
std::vector<float> fTensor_dense1Relu0 = std::vector<float>(16);
...
Session(std::string filename ="") {
   ...
   f.close();
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_densebias0,{ 16 }, { 1 , 16 });
      std::copy(data, data + 16, tensor_densebias0bcast);
      delete [] data;
   }
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_dense1bias0,{ 16 }, { 1 , 16 });
      std::copy(data, data + 16, tensor_dense1bias0bcast);
      delete [] data;
   }
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_dense2bias0,{ 16 }, { 1 , 16 });
      std::copy(data, data + 16, tensor_dense2bias0bcast);
      delete [] data;
   }
   {
...
//--------- Gemm
   ...
   int op_0_lda = 8;
   int op_0_ldb = 16;
   std::copy(tensor_densebias0bcast, tensor_densebias0bcast + 16, tensor_denseDense);
...
//--------- Gemm
   ...
   int op_2_lda = 16;
   int op_2_ldb = 16;
   std::copy(tensor_dense1bias0bcast, tensor_dense1bias0bcast + 16, tensor_dense1Dense);
...
//--------- Gemm
   ...
   int op_4_lda = 16;
   int op_4_ldb = 16;
   std::copy(tensor_dense2bias0bcast, tensor_dense2bias0bcast + 16, tensor_dense2Dense);
