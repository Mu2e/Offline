...
//
// The fit function has been modified to include the correlations in the adcs (signal bins are fully correlated)
...
namespace mu2e {
   ...
   STMTemplateWFUtil::STMTemplateWFUtil(double minPeakAmplitude, double digiSampling, double minDTPeaks, int printLevel) :
   ...
   //-----------------------------------------------------------------------------------------------------
   void   STMTemplateWFUtil::initialize ()                                                                 {pulseCache_.buildShapes();}
   void   STMTemplateWFUtil::reset      ()                                                                 {param_.clear(); paramErr_.clear(); nParTot_=0; npTot_ = 0;}
   void   STMTemplateWFUtil::setXYVector(const std::vector<double>& xvec, const std::vector<double>& yvec) {xvec_ = xvec; yvec_ = yvec; x0_=0; x1_ = xvec_.size();}
   void   STMTemplateWFUtil::setPar     (const std::vector<double>& par)                                   {param_ = par; nParTot_ = npTot_ = par.size();}

   //-----------------------------------------------------------------------------------------------------
   void STMTemplateWFUtil::fit()
   {
       status_ = 0;
   ...
   //-----------------------------------------------------------------------------------------------------
   void STMTemplateWFUtil::refitEdge()
   {
       status_ = 0;
   ...
   //----------------------------------------------------------------------------------
   bool STMTemplateWFUtil::selectComponent(const std::vector<double>& tempPar, const std::vector<double>& tempErr, unsigned ip)
   {
   ...
   //----------------------------------------------------------------------
   double STMTemplateWFUtil::eval_fcn(double x)
   {
       if (param_.size()<nParFcn_) return 0.0;
       return fitfunction(x,&param_[0]);
   }
   //------------------------------------------------------------
   double STMTemplateWFUtil::eval_logn(double x, int ioffset)
   {
       if (param_.size() < ioffset+nParFcn_) return 0.0;
       return logn(x,&param_[ioffset]);
   }
   //------------------------------------------------------------
   double STMTemplateWFUtil::maxAmplitude()
   {
   ...
   //------------------------------------------------------------
   double STMTemplateWFUtil::peakNorm(const std::vector<double>& xvalues, const std::vector<double>& yvalues, double x0, unsigned i0, unsigned i1)
   {
      double s1(0),s2(0);
   ...
   //------------------------------------------------------------
   double STMTemplateWFUtil::sumSquare(const std::vector<double>& xvalues, const std::vector<double>& yvalues, double x0, unsigned i0, unsigned i1)
   {
   ...
   //------------------------------------------------------------
   double STMTemplateWFUtil::peakToFunc(unsigned ip, double xmax, double ymax)
   {
   ...
   //---------------------------------------------------------------------------
   void STMTemplateWFUtil::plotFit(const std::string& pname) const
   {
