#ifndef STMTemplateWFUtil_HH
#define STMTemplateWFUtil_HH
...
namespace mu2e {
  ...
  class STMTemplateWFUtil  {

     public:
        STMTemplateWFUtil(double minPeakAmplitude, double digiSampling, double minDTPeaks, int printLevel=-1);
