#ifndef GeometryService_RecoGeometryService_hh
#define GeometryService_RecoGeometryService_hh
//
...
// Forward declarations
  ...
  class RecoGeometryService {
public:
    RecoGeometryService(const fhicl::ParameterSet&, art::ActivityRegistry&);
    ~RecoGeometryService();
...
private:
    ...
    RecoGeometryService const& operator=(RecoGeometryService const& rhs);
    RecoGeometryService(RecoGeometryService const& rhs);
    ...
    // Some information that is provided through the RecoGeometryService
...
DECLARE_ART_SERVICE(mu2e::RecoGeometryService, LEGACY)
#endif /* GeometryService_RecoGeometryService_hh */
