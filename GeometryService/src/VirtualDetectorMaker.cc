...
//        CLHEP::Hep3Vector holeLocation = ENSCBcentersOfBoxes[ib];
      ...
      const double stmDnStrEnvToSSCBack = -stmDnStrEnvPositionInMu2e.z() + pSTM_SSCParams.originInMu2e().z() - (pSTM_SSCParams.Wdepth_f()/2) + pFrontShieldingParams.Front_Thickness() - c.getDouble("stm.BackShielding.BPThick") - c.getDouble("stm.BackShielding.PipeGap");
