...
int mu2e::ValSimParticle::declare(const art::TFileDirectory& tfs) {
  ...
  _hsxDS =
      tfs.make<TH1D>("XstartDS", "start X DS", 100, -3904 - 1000, -3904 + 1000);
  ...
  _hexDS =
      tfs.make<TH1D>("XendDS", "end X DS", 100, -3904 - 1000, -3904 + 1000);
  ...
  _hscodehendKE =
      tfs.make<TH1D>("scodehendKE", "start code, endKE>10", 151, -0.5, 150.0);
  _hecodehendKE =
      tfs.make<TH1D>("ecodehendKE", "end code, endKE>10", 151, -0.5, 150.0);
  _idh9endKE.declare(tfs, "idh9endKE", "id fold, endKE>95");
  _hscodeh9endKE =
      tfs.make<TH1D>("scodeh9endKE", "start code, endKE>95", 151, -0.5, 150.0);
  _hecodeh9endKE =
      tfs.make<TH1D>("ecodeh9endKE", "end code, endKE>95", 151, -0.5, 150.0);
  ...
  _tgtmux =
      tfs.make<TH1D>("tgtmux", "target stopped mu x", 50, -4000.0, -3800.0);
  ...
  _tgtmut =
      tfs.make<TH1D>("tgtmut", "target stopped mu time", 100, 0.0, 2000.0);
  return 0;
}
