//Code generated automatically by TMVA for Inference of Model file [TrainCluster.h5] at [Tue Jan  3 04:59:49 2023] 
...
std::vector<float> fTensor_dense3kernel0 = std::vector<float>(8);
...
std::vector<float> fTensor_dense1bias0 = std::vector<float>(8);
float * tensor_dense1bias0 = fTensor_dense1bias0.data();
std::vector<float> fTensor_dense1kernel0 = std::vector<float>(64);
float * tensor_dense1kernel0 = fTensor_dense1kernel0.data();
std::vector<float> fTensor_densebias0 = std::vector<float>(8);
float * tensor_densebias0 = fTensor_densebias0.data();
std::vector<float> fTensor_densekernel0 = std::vector<float>(32);
...
std::vector<float> fTensor_dense2Dense = std::vector<float>(8);
float * tensor_dense2Dense = fTensor_dense2Dense.data();
std::vector<float> fTensor_dense1Relu0 = std::vector<float>(8);
...
std::vector<float> fTensor_dense2Relu0 = std::vector<float>(8);
float * tensor_dense2Relu0 = fTensor_dense2Relu0.data();
std::vector<float> fTensor_dense1Dense = std::vector<float>(8);
float * tensor_dense1Dense = fTensor_dense1Dense.data();
std::vector<float> fTensor_denseRelu0 = std::vector<float>(8);
float * tensor_denseRelu0 = fTensor_denseRelu0.data();
std::vector<float> fTensor_denseDense = std::vector<float>(8);
...
//--------- Gemm
   ...
   int op_0_lda = 4;
   int op_0_ldb = 8;
   std::copy(tensor_densebias0, tensor_densebias0 + 8, tensor_denseDense);
...
//--------- Gemm
   ...
   int op_2_lda = 8;
   int op_2_ldb = 8;
   std::copy(tensor_dense1bias0, tensor_dense1bias0 + 8, tensor_dense1Dense);
...
//--------- Gemm
   ...
   int op_4_lda = 8;
   int op_4_ldb = 8;
   std::copy(tensor_dense2bias0, tensor_dense2bias0 + 8, tensor_dense2Dense);
