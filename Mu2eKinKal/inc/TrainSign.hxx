//Code generated automatically by TMVA for Inference of Model file [TrainSign.h5] at [Mon Jan  2 21:02:02 2023] 

#ifndef TMVA_SOFIE_TRAINSIGN
#define TMVA_SOFIE_TRAINSIGN
...
namespace TMVA_SOFIE_TrainSign{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "TrainSign.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_TrainSign

#endif  // TMVA_SOFIE_TRAINSIGN
