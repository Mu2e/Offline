//Code generated automatically by TMVA for Inference of Model file [TrainDrift.h5] at [Wed Dec 28 05:14:47 2022] 
...
std::vector<float> fTensor_dense2Dense = std::vector<float>(12);
float * tensor_dense2Dense = fTensor_dense2Dense.data();
std::vector<float> fTensor_dense1Relu0 = std::vector<float>(12);
...
std::vector<float> fTensor_dense2Relu0 = std::vector<float>(12);
float * tensor_dense2Relu0 = fTensor_dense2Relu0.data();
std::vector<float> fTensor_dense1Dense = std::vector<float>(12);
float * tensor_dense1Dense = fTensor_dense1Dense.data();
std::vector<float> fTensor_denseRelu0 = std::vector<float>(12);
float * tensor_denseRelu0 = fTensor_denseRelu0.data();
std::vector<float> fTensor_denseDense = std::vector<float>(12);
...
//--------- Gemm
   ...
   int op_0_lda = 6;
   int op_0_ldb = 12;
   std::copy(tensor_densebias0, tensor_densebias0 + 12, tensor_denseDense);
...
//--------- Gemm
   ...
   int op_2_lda = 12;
   int op_2_ldb = 12;
   std::copy(tensor_dense1bias0, tensor_dense1bias0 + 12, tensor_dense1Dense);
...
//--------- Gemm
   ...
   int op_4_lda = 12;
   int op_4_ldb = 12;
   std::copy(tensor_dense2bias0, tensor_dense2bias0 + 12, tensor_dense2Dense);
