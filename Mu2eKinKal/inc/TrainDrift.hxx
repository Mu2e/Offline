//Code generated automatically by TMVA for Inference of Model file [TrainDrift.h5] at [Thu Dec 29 03:31:09 2022] 

#ifndef TMVA_SOFIE_TRAINDRIFT
#define TMVA_SOFIE_TRAINDRIFT
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "TrainDrift.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_TrainDrift

#endif  // TMVA_SOFIE_TRAINDRIFT
