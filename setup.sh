...
export MU2E_ART_SQUALIFIER=s84
...
setup -B art v3_02_06 -q${MU2E_UPS_QUALIFIERS}
setup -B art_root_io v1_00_06 -q${MU2E_UPS_QUALIFIERS}
...
setup -B mu2e_artdaq_core v1_02_22 -q${MU2E_UPS_QUALIFIERS}:+${MU2E_ART_SQUALIFIER}:offline

# Other libraries we need.
setup -B pcie_linux_kernel_module v2_02_02 -q${MU2E_UPS_QUALIFIERS}
