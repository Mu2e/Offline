...
export MU2E_ART_SQUALIFIER=s72
...
setup -B art v2_11_04 -q${MU2E_UPS_QUALIFIERS}
...
setup -B mu2e_artdaq_core v1_02_09 -q${MU2E_UPS_QUALIFIERS}:+${MU2E_ART_SQUALIFIER}:offline
