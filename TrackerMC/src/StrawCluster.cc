...
namespace mu2e {
  namespace TrackerMC {
    StrawCluster::StrawCluster() : _type(unknown), _strawId(0), _end(TrkTypes::cal), _time(0.0), _charge(0.0), _ddist(0.0),_phi(0.0),  _wdist(0.0), _drifttime(0.0), _proptime(0.0)
    {}//JB: added phi
