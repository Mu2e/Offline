...
namespace MinuitDriftFitter{
	 FitResult DoFit(int _diag, CosmicTrackFinderData& trackdata, StrawResponse::cptr_t srep, const Tracker* tracker,double max_doca, unsigned int minChits, int MaxLogL, double _gaussTres, double maxTres){
