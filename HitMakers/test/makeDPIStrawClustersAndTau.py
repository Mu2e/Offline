...
#
# $Id: makeDPIStrawClustersAndTau.py,v 1.1 2011/05/12 19:23:55 mf Exp $
# $Author: mf $
...
process.TFileService = mu2e.Service("TFileService",
                       fileName = mu2e.string("makeDPISCsBetaTauTheta.root"),
...
process.testSC = mu2e.EDAnalyzer("BetaTauPitch",
       g4ModuleLabel = mu2e.string("g4run"),                             
    makerModuleLabel = mu2e.string("makeSH"),                            
