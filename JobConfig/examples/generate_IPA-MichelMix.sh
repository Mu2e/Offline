...
generate_fcl --description IPA-MichelMix --dsconf MDC2018a --dsowner mu2e --include JobConfig/mixing/IPA-MichelMix.fcl \
--run-number 1002 --events-per-job 4000 --njobs 5000 --max-engines 30 \
