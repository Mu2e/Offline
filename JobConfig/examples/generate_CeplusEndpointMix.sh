...
generate_fcl --description CeplusEndpointMix --dsconf MDC2018a --dsowner mu2e --include JobConfig/mixing/CeplusEndpointMix.fcl \
...
rm -rf CeplusEndpointMix
mv 000 CeplusEndpointMix
