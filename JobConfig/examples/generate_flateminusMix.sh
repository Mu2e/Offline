generate_fcl --description flateminusMix --dsconf MDC2018a --dsowner mu2e --include JobConfig/mixing/flateminusMix.fcl \
--run-number 1002 --events-per-job 500 --njobs 40000 --max-engines 30 \
...
--auxinput=2:physics.filters.ootMixerTrkCal.fileNames:oot-TrkCal-cat.txt \
