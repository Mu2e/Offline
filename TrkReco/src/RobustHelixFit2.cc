...
namespace mu2e
{
  ...
  RobustHelixFit2::RobustHelixFit2(fhicl::ParameterSet const& pset) :
    ...
    _ntripleMax(pset.get<unsigned>("ntripleMax",100000))
  {
    if (_helicity._value == Helicity::unknown)
      throw cet::exception("RECO")<<"mu2e::RobustHelixFit2: Invalid Helicity specified"<< std::endl;
  ...
  RobustHelixFit2::~RobustHelixFit2()
  {}
  ...
  bool RobustHelixFit2::initFZ(HelixHitCollection& hhits,RobustHelix& rhel)
  {      
      bool retval(false);
  ...
  void RobustHelixFit2::fitFZ(HelixSeed& hseed) 
  {
  ...
  double RobustHelixFit2::deltaPhi(double phi1, double phi2)
  {
  ...
  void RobustHelixFit2::setOutlier(HelixHit& hhit) const 
  {
