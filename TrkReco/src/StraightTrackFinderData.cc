...
//-----------------------------------------------------------------------------
// StraightTrackFinderData
//-------------construct:----------------------------------
  StraightTrackFinderData::StraightTrackFinderData() {
...
//-----------------------------------------------------------------------------
  void StraightTrackFinderData::orderID(StraightTrackFinderData::ChannelID* X, StraightTrackFinderData::ChannelID* O) {
/*
...
//-----------------------------------------------------------------------------
  void StraightTrackFinderData::clearTempVariables() {
...
// don't clear the diagnostics part.
//-----------------------------------------------------------------------------
   void StraightTrackFinderData::clearResults() {
...
//-----------------------------------------------------------------------------
  void StraightTrackFinderData::print(const char* Title) {

    printf(" StraightTrackFinderData::print: %s\n",Title);
