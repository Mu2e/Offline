...
#ifndef StraightTrackFinderData_HH
#define StraightTrackFinderData_HH
...
#include "RecoDataProducts/inc/StraightTrackSeed.hh" //CHANGE SEED
...
namespace mu2e {
  ...
  public:
    ...
    StraightTrackSeed                         _tseed;
    //TODO:decide on best way to use this::LsqSums4         _sxy;
...
//-----------------------------------------------------------------------------
    ...
    //const StraightTrackSeedCollection*   stcol(){return      _stcol;}
