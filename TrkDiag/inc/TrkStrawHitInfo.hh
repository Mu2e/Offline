...
namespace mu2e 
{
  struct TrkStrawHitInfo {
    ...
    Float_t _tddist, _tdderr;	// Distance from the straw center predicted by the time difference measurement (and error)
    ...
    _ht(-1000.0), _tddist(-1000.0), _tdderr(-1000.0), _hlen(-1000.0), _wdot(-1000.0), 
