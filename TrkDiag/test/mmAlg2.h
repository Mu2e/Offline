...
#ifdef mmAlg2_cxx
mmAlg2::mmAlg2(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   ...
   Init(tree);
   h1 = new TH2F("h1","docaReco vs (rdrift - doca)",100,0,2.5,100,-2.5,2.5);
   prof1 = new TProfile("prof1","TProfile of docaReco vs (rdrift - doca)",100,0,2.5,-2.5,2.5,"s");
 }
...
Int_t mmAlg2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mmAlg2::LoadTree(Long64_t entry)
{
...
void mmAlg2::Show(Long64_t entry)
{
...
Int_t mmAlg2::Cut(Long64_t entry)
{
