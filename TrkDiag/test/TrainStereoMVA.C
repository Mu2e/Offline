...
void TrainStereoMVA(const char* filename)
{
  ...
  TString outfileName("TrainStereo.root");
  ...
  (TMVA::gConfig().GetIONames()).fWeightFileDir = "MakeStereoWeights";

  // Define the input variables that shall be used for the MVA training
  // note that you may also use variable expressions, such as: "3*var1/var2*abs(var3)"
  // [all types of expressions that can also be parsed by TTree::Draw( "expression" )]

  factory->AddVariable("de",'F'); 
...
//  factory->AddVariable("dz", 'F');
  ...
  */
  ...
  TCut signalCut = "mcrel>=0";
  TCut backgrCut = "mcrel<0";
