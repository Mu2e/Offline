...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TH1F *_wpavg, *_wpfrac;
   TH2F* _wpfracmom, *_wpavgmom;
   TH2F* _wpfractq, *_wpavgtq;
...
#ifdef Wpull_cxx
Wpull::Wpull(TTree *tree) : fChain(0) 
{
...
Int_t Wpull::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Wpull::LoadTree(Long64_t entry)
{
...
void Wpull::Init(TTree *tree)
{
    _wpavg = new TH1F("wpavg","Average of wpull",100,0.0,5.0);
    _wpfrac = new TH1F("wpfrac","Fraction of large wpull hits",100,0.0,0.25);
    _wpavgmom = new TH2F("wpavg","Average of wpull vs mom diff",50,0.0,5.0,50,0.0,5.0);
    _wpfracmom = new TH2F("wpfrac","Fraction of large wpull hits vs mom diff",50,0.0,5.0,50,0.0,0.25);
    _wpavgtq = new TH2F("wpavg","Average of wpull vs tq",50,0.0,1.0,50,0.0,5.0);
    _wpfractq = new TH2F("wpfrac","Fraction of large wpull hits vs tq",50,0.0,1.0,50,0.0,0.25);
...
void Wpull::Show(Long64_t entry)
{
...
Int_t Wpull::Cut(Long64_t entry)
{
