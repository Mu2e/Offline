...
class TimePDFFit : public ROOT::Minuit2::FCNBase {
  public:
    ...
    int nparams =5;
    double doca_min = 0;
    double doca_max = 2000;

     TimePDFFit(ComboHitCollection _chits, std::vector<Straw> &_straws, StrawResponse _srep, std::vector<double> &_constraint_means, std::vector<double> &_constraints, int _k) :  chits(_chits), straws(_straws), srep(_srep), constraint_means(_constraint_means), constraints(_constraints) {};
