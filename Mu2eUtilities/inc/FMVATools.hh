...
namespace mu2e 
{
  ...
  constexpr size_t max_synapses=6;
  ...
  public:
    explicit FMVATools(fhicl::ParameterSet const& pars):
    _x(),_y(),_first_layer(),_inner_layers(),_mva_tools(pars) {}    
    
    virtual ~FMVATools() {}
    
    void initMVA();
    value_t evalMVA(inp_params_t const& /*params*/);
  private:
