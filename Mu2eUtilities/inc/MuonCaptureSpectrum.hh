...
namespace mu2e {
  ...
  public:
    ...
    ~MuonCaptureSpectrum(){}
    MuonCaptureSpectrum(const bool kMaxUserSet, const double kMaxUser) : _kMaxUserSet( kMaxUserSet), _kMaxUser( kMaxUser) {}
    ...
    static double getRMCSpectrum( const double e , const bool kMaxUserSet, const double kMaxUser);
