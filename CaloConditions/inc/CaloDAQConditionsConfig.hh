#ifndef CaloConditions_CaloDAQConditionsConfig_hh
#define CaloConditions_CaloDAQConditionsConfig_hh
//
// Initialize CaloDAQConditions from fcl
//
#include <string>
...
namespace mu2e {
  ...
  struct CaloDAQConditionsConfig {
