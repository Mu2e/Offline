...
//
// $Id: StepInstanceName.hh,v 1.2 2012/03/29 15:00:13 kutschke Exp $
// $Author: kutschke $
// $Date: 2012/03/29 15:00:13 $
//
...
namespace mu2e {
  ...
  public:
    ...
    enum enum_type {
      unknown,
      tracker, virtualdetector, timeVD, stoppingtarget, CRV, calorimeter, calorimeterRO,
      ExtMonFNAL, ExtMonUCITof, ttrackerDS,
      lastEnum
    };
