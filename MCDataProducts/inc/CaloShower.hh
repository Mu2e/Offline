...
namespace mu2e {
   ...
   class CaloShower {
	  ...
	  CaloShower(): crystalId_(-1),steps_(),time_(0),energy_(0),energyMC_(0) {}
	  
	  CaloShower(int crystalId, caloStepPtrs const& steps, double time, double energy, double energyMC): 
