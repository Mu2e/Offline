...
namespace mu2e {
  ...
  public:
    ...
    enum enum_type {
      ...
      cosmicCRY, cosmicCORSIKA, pbarFlat, fromAscii, ExternalRMC, InternalRMC, CeLeadingLog, //43
      lastEnum //44
    };
...
#define GENID_NAMES                                                     \
    "unknown",      "particleGun",       "CeEndpoint",               \
      ...
      "CosmicCRY", "CosmicCORSIKA", "pbarFlat","fromAscii","ExternalRMC","InternalRMC","CeLeadingLog"
