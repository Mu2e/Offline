...
namespace mu2e {
   ...
   class CaloShowerStep {
	  ...
	  CaloShowerStep(): volumeId_(-1),sim_(),nCompress_(0),time_(0),energyMC_(0),momentumIn_(0),pos_(),covPos_() {}
	  
	  CaloShowerStep(int volumeId, art::Ptr<SimParticle> const& sim, int nCompress, double time,  
	                   double energy, double momentumIn, CLHEP::Hep3Vector& pos, CLHEP::HepSymMatrix& covPos): 
	    volumeId_(volumeId),
	    sim_(sim),
