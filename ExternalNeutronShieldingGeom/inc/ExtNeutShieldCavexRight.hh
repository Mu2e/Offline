#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldCavexRight_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldCavexRight_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldCavexRight : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldCavexRightMaker;

    // Private ctr: the class should only be constructed via ExtNeutShieldCavexRight::ExtNeutShieldCavexRightMaker.
    ExtNeutShieldCavexRight(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldCavexRight& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldCavexRight_hh*/
