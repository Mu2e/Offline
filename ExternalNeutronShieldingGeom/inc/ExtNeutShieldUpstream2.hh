#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldUpstream2_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldUpstream2_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldUpstream2 : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldUpstream2Maker;

    // Private ctr: the class should only be constructed via ExtNeutShieldUpstream2::ExtNeutShieldUpstream2Maker.
    ExtNeutShieldUpstream2(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldUpstream2& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldUpstream2_hh*/
