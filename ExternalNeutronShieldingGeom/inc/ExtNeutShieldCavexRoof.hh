#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldCavexRoof_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldCavexRoof_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldCavexRoof : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldCavexRoofMaker;

    // Private ctr: the class should only be constructed via ExtNeutShieldCavexRoof::ExtNeutShieldCavexRoofMaker.
    ExtNeutShieldCavexRoof(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldCavexRoof& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldCavexRoof_hh*/
