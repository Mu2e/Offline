#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldUpstreamTop_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldUpstreamTop_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldUpstreamTop : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldUpstreamTopMaker;

    // Private ctr: the class should only be constructed via ExtNeutShieldUpstreamTop::ExtNeutShieldUpstreamTopMaker.
    ExtNeutShieldUpstreamTop(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldUpstreamTop& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldUpstreamTop_hh*/
