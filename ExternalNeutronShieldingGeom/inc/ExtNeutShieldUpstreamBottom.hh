#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldUpstreamBottom_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldUpstreamBottom_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldUpstreamBottom : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldUpstreamBottomMaker;

    // Private ctr: the class should only be constructed via ExtNeutShieldUpstreamBottom::ExtNeutShieldUpstreamBottomMaker.
    ExtNeutShieldUpstreamBottom(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldUpstreamBottom& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldUpstreamBottom_hh*/
