#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldCavexLeft_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldCavexLeft_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldCavexLeft : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldCavexLeftMaker;

    // Private ctr: the class should only be constructed via ExtNeutShieldCavexLeft::ExtNeutShieldCavexLeftMaker.
    ExtNeutShieldCavexLeft(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldCavexLeft& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldCavexLeft_hh*/
