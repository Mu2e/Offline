#ifndef ExternalNeutronShieldingGeom_ExtNeutShieldCavexRightb_hh
#define ExternalNeutronShieldingGeom_ExtNeutShieldCavexRightb_hh
...
namespace mu2e {
  ...
  class ExtNeutShieldCavexRightb : virtual public Detector {
  ...
  private:
    ...
    friend class ExtNeutShieldCavexRightbMaker;

    // Private ctr: the class should only be constructed via ExtNeutShieldCavexRightb::ExtNeutShieldCavexRightbMaker.
    ExtNeutShieldCavexRightb(const std::vector<CLHEP::Hep2Vector>& shape, const double& leng, const std::string mat, const CLHEP::Hep3Vector site, const double& rot )
  ...
  std::ostream& operator<<(std::ostream& os, const ExtNeutShieldCavexRightb& ensu1a);

}

#endif/*ExternalNeutronShieldingGeom_ExtNeutShieldCavexRightb_hh*/
