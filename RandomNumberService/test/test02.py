...
#
# $Id: test02.py,v 1.1 2010/03/07 22:01:00 kutschke Exp $
# $Author: kutschke $
# $Date: 2010/03/07 22:01:00 $
#
# Restore state at start of each event
# Test fire instances of Randflat and RandGaussQ on even
...
process.rngtest     = mu2e.EDAnalyzer("RNGTest",
                       doSkip= mu2e.untracked.int32(1),
                      )
process.outfile     = mu2e.OutputModule("PoolOutputModule",
                      fileName = mu2e.untracked.string('file:randomtest_02.root'),
)
