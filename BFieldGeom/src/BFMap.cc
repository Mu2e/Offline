...
namespace mu2e {
    ...
    bool BFMap::isGMCValid(CLHEP::Hep3Vector const& point) const { return true; }

    CLHEP::Hep3Vector BFMap::cellFraction(const CLHEP::Hep3Vector& pos,
    ...
    bool BFMap::getNeighbors(int ix, int iy, int iz, CLHEP::Hep3Vector neighborsBF[3][3][3]) const {
        for (int i = 0; i != 3; ++i) {
