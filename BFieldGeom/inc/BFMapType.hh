...
#define BFMAPTYPE_NAMES "unknown", "GMC", "G4BL"
  ...
  public:
    ...
    bool operator==(BFMapType const g) const{
      return ( _id == g._id );
    }

    bool operator==(BFMapType::enum_type const g) const{
      return ( _id == g );
    }
