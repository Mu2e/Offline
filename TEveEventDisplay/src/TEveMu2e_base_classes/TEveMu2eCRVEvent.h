...
namespace mu2e {
  class TEveMu2eCRVEvent : public TEvePointSet {
    public:
      ...
      //std::tuple<std::array<double, 3>, std::array<double, 3>> DrawSciBar();
    std::tuple<std::array<double, 3>, CLHEP::Hep3Vector, CLHEP::Hep3Vector> DrawSciBar();
      void DrawHit2D(const std::string &pstr, Int_t b,CLHEP::Hep3Vector HitPos, TEveElementList *list2DXY, TEveElementList *list2DYZ);
