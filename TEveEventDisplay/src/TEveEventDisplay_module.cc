...
namespace mu2e
{
  ...
  void TEveEventDisplay::beginJob(){
    ...
    DrawOptions DrawOpts(_filler.addCrvHits_, _filler.addCosmicSeedFit_, _filler.addTracks_, _filler.addClusters_, _filler.addHits_, _filler.addTrkHits_, false, _filler.addMCTraj_); 
