# Configuration file for Kalman tests - run enough events to
# get stats in histograms.
#
# $Id: test02.py,v 1.1 2010/04/23 20:18:57 kutschke Exp $
# $Author: kutschke $
...
process = mu2e.Process("KalmanTest02")
...
process.TFileService = mu2e.Service("TFileService",
                       fileName = mu2e.string("kalmantest_02.root"),
...
process.kalmanTest = mu2e.EDAnalyzer("KalmanT01",
     ...
     maxFullPrint = mu2e.untracked.int32(1)
)
