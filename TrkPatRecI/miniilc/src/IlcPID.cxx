...
/* $Id: IlcPID.cxx,v 1.1 2012/12/04 00:51:27 tassiell Exp $ */
...
const char* IlcPID::fgkParticleName[IlcPID::kSPECIESN+1] = {
  "electron",
  "muon",
  "pion",
  "kaon",
...
const Int_t IlcPID::fgkParticleCode[IlcPID::kSPECIESN+1] = {
  ::kElectron, 
  ::kMuonMinus, 
  ::kPiPlus, 
  ::kKPlus, 
...
/*const*/ Float_t IlcPID::fgkParticleMass[IlcPID::kSPECIESN+1] = {
...
{
  //
  // Initiilcse the masses
  //
  // Initiilcse only once... 
				...
				const Double_t* prior) const
{
  ...
  if (sum <= 0) {
    IlcError("Invilcd probability densities or priors");
    return -1;
  }
