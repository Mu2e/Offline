...
/* $Id: IlcHelix.cxx,v 1.1 2012/12/04 00:51:27 tassiell Exp $ */

//-------------------------------------------------------------------------
//                Implementation of the IlcHelix class
...
//_______________________________________________________________________
IlcHelix::IlcHelix(const IlcHelix &t):TObject(t){
  //
  //
  for (Int_t i=0;i<9;i++) 
    fHelix[i]=t.fHelix[i];
...
IlcHelix::IlcHelix(const IlcKalmanTrack &t)
{
  //
  // 
  ...
  fHelix[4]=fHelix[4]/(1000/0.299792458/IlcTracker::GetBz());    // C
  ...
  if (dummy<0) {
    IlcError(Form("The argument of the Sqrt is %f => set to 0\n",dummy));
    dummy = 0;
  }
...
IlcHelix::IlcHelix(const IlcExternalTrackParam &t)
{
  //
  // 
  Double_t alpha,x,cs,sn;
...
IlcHelix::IlcHelix(Double_t x[3], Double_t p[3], Double_t charge, Double_t conversion)
{
  //
  //
  //
  ...
  if (TMath::Abs(conversion)<0.00000001) 
    conversion = 1000/0.299792458/IlcTracker::GetBz();
  //
  //  
...
void  IlcHelix::GetMomentum(Double_t phase, Double_t p[4],Double_t conversion, Double_t *xr)
{
  // return  momentum at given phase
  Double_t x[3],g[3],gg[3];
  Evaluate(phase,x,g,gg);
  if (TMath::Abs(conversion)<0.0001) conversion = 1000/0.299792458/IlcTracker::GetBz();
...
void   IlcHelix::GetAngle(Double_t t1, IlcHelix &h, Double_t t2, Double_t angle[3])
{
  //
  //
  //
...
void IlcHelix::Evaluate(Double_t t,
...
Int_t     IlcHelix::GetClosestPhases(IlcHelix &h, Double_t phase[2][2])
{
  //
...
Double_t  IlcHelix::GetPointAngle(IlcHelix &h, Double_t phase[2], const Float_t * vertex)
{
  //
...
Double_t  IlcHelix::GetPhase(Double_t x, Double_t y )
...
Int_t IlcHelix::GetPhase(Double_t /*r0*/, Double_t * /*t[2]*/) 
{
  //
...
Double_t  IlcHelix::GetPhaseZ(Double_t z0)
{
  //
  //
...
Int_t    IlcHelix::GetRPHIintersections(IlcHelix &h, Double_t phase[2][2], Double_t ri[2], Double_t cut)
{
  //--------------------------------------------------------------------
...
Int_t   IlcHelix::LinearDCA(IlcHelix &h, Double_t &t1, Double_t &t2, 
...
Int_t  IlcHelix::ParabolicDCA(IlcHelix&h,  //helixes
...
Int_t  IlcHelix::ParabolicDCA2(IlcHelix&h,  //helixes
			       Double_t &t1, Double_t &t2, 
