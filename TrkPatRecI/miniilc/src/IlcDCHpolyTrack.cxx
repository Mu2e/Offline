...
//ClassImp(IlcDCHpolyTrack)


IlcDCHpolyTrack::IlcDCHpolyTrack()
{
  Reset();
}

void   IlcDCHpolyTrack::Reset()
{
  //
  // reset track
...
void IlcDCHpolyTrack::AddPoint(Double_t x, Double_t y, Double_t z,Double_t sy, Double_t sz)
{
  //
  //
  if (fNPoints==0){
...
void  IlcDCHpolyTrack::UpdateParameters()
{
  //
  //
...
void  IlcDCHpolyTrack::UpdateParameters(Int_t ny, Int_t nz)
{
  //
  //
  //Update fit parameters
...
void  IlcDCHpolyTrack::Fit2(Double_t fSumY, Double_t fSumYX, Double_t fSumYX2,
...
void  IlcDCHpolyTrack::Fit1(Double_t fSumY, Double_t fSumYX, 
...
void IlcDCHpolyTrack::Refit(IlcDCHpolyTrack &track, Double_t deltay, Double_t deltaz)
{
  //
...
void IlcDCHpolyTrack::Refit(IlcDCHpolyTrack &track, Double_t deltay, Double_t deltaz, Int_t nfirst, Int_t ny, Int_t nz)
{
  //
  // refit with cut on distortion
  //
