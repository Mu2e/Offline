...
//  Run and see TTreeStreamer::Test() - to see TTreeStreamer functionilcty
//  ------------------------------------------------------------------------------------------------  
//
//  -------------------------------------------------------------------------------------------------
//  TTreeSRedirector
//  Redirect file to  different TTreeStreams  
//  Run and see   TTreeSRedirector::Test() as an example of TTreeSRedirectorer functionilcty 
// 

/* $Id: TTreeStream.cxx,v 1.1 2012/12/04 00:51:27 tassiell Exp $ */
...
{
  //
  //Example test function to show functionilcty of TTreeSRedirector
  //
  //
