...
//
//
// $Id: TrackCaloMatching_module.cc,v 1.1 2014/06/02 22:26:15 murat Exp $
// $Author: murat $
...
//-----------------------------------------------------------------------------
  ...
  double TrackCaloMatching::chiSquare(double& exV, double& exW, double& clV, double& clW, double& sigmaV2,
				 double& sigmaW2, double& extrT , double& clT, double& sigmaT2,
				 double& exEnergy, double& clEnergy, double& sigmaE2, int index){
  ...
  void TrackCaloMatching::initntuple(){
...
//     art::ProductID caloClusterCollID(getProductID<CaloClusterCollection>(evt,_caloClusterCollName)); 
//     art::ProductID kalRepCollID     (getProductID<KalRepCollection>     (evt,_iname              ));
