...
// Wrapper functions for functions found in FitModel.hh
// All truncated functions have the same input parameters as their
// untruncated counterparts. 
namespace mu2e{
...
namespace FitModelRoot{
	...
	Float_t singlePeakTrunc(Double_t *x, Double_t *par);

	//Fitting function for single peak 
	Float_t singlePeak(Double_t *x, Double_t *par);
	Float_t singlePeakTrunc(Double_t *x, Double_t *par);
	...
	Float_t singlePeakFloatingPedestal(Double_t *x, Double_t *par);
	Float_t singlePeakFloatingPedestalTrunc(Double_t *x, Double_t *par);
	...
	Float_t EXPeakTrunc(Double_t *x, Double_t *par);
