...
#
#   $Id: protonBG.sh,v 1.1 2012/07/15 16:01:19 kutschke Exp $
#   $Author: kutschke $
...
updateFCLFile.sh $baseRunNumber $maxUniqueEngines $cluster $process protonBG.fcl thisjob.fcl

# Run the Offline job.
time mu2e -c thisjob.fcl -n 5200000 >& thisjob.log
