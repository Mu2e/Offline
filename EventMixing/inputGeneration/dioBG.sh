#! /bin/bash
#
# A grid script to generate dio backgrounds in the tracker and calorimeter
#
#   $Id: dioBG.sh,v 1.1 2012/07/15 16:01:19 kutschke Exp $
#   $Author: kutschke $
...
updateFCLFile.sh $baseRunNumber $maxUniqueEngines $cluster $process dioBG.fcl thisjob.fcl

# Run the Offline job.
time mu2e -c thisjob.fcl -n 1250000 >& thisjob.log
