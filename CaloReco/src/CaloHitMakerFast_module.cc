...
namespace mu2e {
  ...
  private:
    ...
    void extractHits(const CaloDigiCollection& caloDigis, CaloHitCollection& caloHitsColl, CaloHitCollection& caphriHitsColl, , IntensityInfoCalo&, double pbtOffset);
