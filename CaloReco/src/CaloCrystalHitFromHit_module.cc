...
namespace mu2e {
  ...
  class CaloCrystalHitFromHit : public art::EDProducer {
    ...
    private:
      ...
      void makeCaloHits(CaloCrystalHitCollection& CaloHits,const art::ValidHandle<CaloRecoDigiCollection>& recoCaloDigisHandle);
...
//Uncache hitMap_
    ...
    for (unsigned crystalId=0;crystalId<hitMap_.size();++crystalId)
    {
