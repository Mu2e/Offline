...
//-----------------------------------------------------------------------------
   ...
   std::list<CaloCrystalHit const*> MakeCaloClusterNew::formCluster(CaloCrystalList& hitList, CaloCrystalList_iter crystalSeed, Calorimeter const & cal)
   {
   ...
   CLHEP::Hep3Vector MakeCaloClusterNew::calculateCog(std::list<CaloCrystalHit const*> cluster, Calorimeter const & cal, int mode) 
   {
   ...
   double MakeCaloClusterNew::closestDistance(std::list<CaloCrystalHit const*> cluster, std::list<CaloCrystalHit const*> cluster2, Calorimeter const & cal) 
   {
