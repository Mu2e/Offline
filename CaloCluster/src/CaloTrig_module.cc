...
namespace mu2e {
  ...
  class CaloTrig : public art::EDProducer {
  ...
  //-------------------------------------------------------
  void CaloTrig::produce(art::Event& event) 
  {
  ...
  //--------------------------------------------------------------------------------------
  void CaloTrig::extractRecoDigi(const art::Handle<CaloDigiCollection>& caloDigisHandle,
					CaloTrigSeedCollection&                 trigSeeds)
  {
