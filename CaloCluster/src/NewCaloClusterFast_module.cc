...
namespace mu2e {
  ...
  private:
    ...
    void extractRecoDigi(const art::Handle<NewCaloDigiCollection>& caloDigisHandle,
  ...
  //--------------------------------------------------------------------------------------
  void CaloClusterFast::extractRecoDigi(const art::Handle<NewCaloDigiCollection>& caloDigisHandle,
                                        CaloClusterCollection&                 recoClusters,
                                        CaloCrystalHitCollection&              recoCrystalHits)
  {

      const NewCaloDigiCollection& caloDigis(*caloDigisHandle);
