#ifndef TrkChargeRecoOld_PeakFitParams_hh
#define TrkChargeRecoOld_PeakFitParams_hh
...
//      enum paramIndex : size_t {earlyCharge=1,pedestal,time,charge,width,lateShift,lateCharge,nParams};
      ...
      // default constructor
      PeakFitParams(): _earlyCharge(0.0), _pedestal(0.0), _time(0.0), _charge(0.0), _width(0.0), _lateShift(0.0), _lateCharge(0.0), _free(0),
	_chi2(-1.0), _ndf(0), _status(-1) {}
      // explicit constructor
      PeakFitParams(Float_t e, Float_t p, Float_t t, Float_t s,Float_t w, Float_t lsh, Float_t lsc, UInt_t f, Float_t chi2, UInt_t ndf, Int_t status) :
	...
	_chi2(chi2), _ndf(ndf), _status(status) {}
      ...
      PeakFitParams(Double_t array[],Double_t chi2=-1., UInt_t ndf=0, Int_t status=-1) : _earlyCharge(array[earlyCharge]),
