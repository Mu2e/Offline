...
//
// $Id: constructDirt.cc,v 1.11 2013/09/30 13:20:41 knoepfel Exp $
// $Author: knoepfel $
// $Date: 2013/09/30 13:20:41 $
//
...
namespace mu2e {
  ...
  void constructDirt(const VolumeInfo& parent, const SimpleConfig& config) {
    ...
    const bool visible             = config.getBool("world.dirt.visible");
    const bool solid               = config.getBool("world.dirt.solid");
