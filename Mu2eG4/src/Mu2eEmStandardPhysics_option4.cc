...
// ********************************************************************
//
// $Id: Mu2eEmStandardPhysics_option4.cc 107332 2017-11-08 16:44:06Z gcosmo $
//
//---------------------------------------------------------------------------
//
...
//
// Modified:
// 15.03.18  K.L.Genser for Mu2e: changed highEnergyLimit to 115MeV
//
...
//
#if G4VERSION>4103
#include "Mu2eEmStandardPhysics_option4.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(Mu2eEmStandardPhysics_option4);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

Mu2eEmStandardPhysics_option4::Mu2eEmStandardPhysics_option4(G4int ver, 
							 const G4String&)
  : G4VPhysicsConstructor("Mu2eEmStandard_opt4"), verbose(ver)
{
...
Mu2eEmStandardPhysics_option4::~Mu2eEmStandardPhysics_option4()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void Mu2eEmStandardPhysics_option4::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void Mu2eEmStandardPhysics_option4::ConstructProcess()
{
  if(verbose > -1) {
  ...
  G4double highEnergyLimit = 115*MeV;
