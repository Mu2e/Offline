...
namespace mu2e {
  scorerDosePrompt::scorerDosePrompt(const G4String& name,
                                     scorerDoseType type,
  ...
  void scorerDosePrompt::Initialize(G4HCofThisEvent* HCE)
  {
  ...
  void scorerDosePrompt::clear() { EvtMap_->clear(); }


  G4bool scorerDosePrompt::ProcessHits(G4Step* aStep, G4TouchableHistory*)
  {
  ...
  G4double scorerDosePrompt::ComputeVolume(G4Step* aStep, G4int idx)
  {
  ...
  G4int scorerDosePrompt::GetIndex(G4Step* aStep)
  {
  ...
  void scorerDosePrompt::PrintAll()
  {
