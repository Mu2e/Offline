...
namespace mu2e {
  ...
  G4bool ITGasLayerSD_Square::ProcessHits(G4Step* aStep, G4TouchableHistory*){
          ...
          ///*debug*/std::cout<<"G4 hit pos in World"<<prePosWorld[0]<<" "<<prePosWorld[1]<<" "<<prePosWorld[2]<<std::endl;
          ...
          try {
                  ///*debug*/std::cout<<"S "<<_superlayer<<" R "<<ring<<std::endl;
                  ...
                  ///*debug*/std::cout<<"stereo "<<itracker->getCellGeometryHandle()->GetWireEpsilon()<<" invcosstereo "<<invcosstereo<<std::endl;
                  itracker->getCellGeometryHandle()->WirePosAtZ(pos[2]/**invcosstereo*/,xywire);

                  ///*debug*/std::cout<<"0 wire center "<<xywire[0]<<" "<<xywire[1]<<" "<<xywire[2]<<std::endl;
                  ///*debug*/std::cout<<"hit pos "<<pos[0]<<" "<<pos[1]<<" "<<pos[2]<<std::endl;
                  ///*debug*/std::cout<<"hit to wire 0 dist "<<sqrt(pow(pos[0]-xywire[0],2)+pow(pos[1]-xywire[1],2)+pow(pos[2]-xywire[2],2))<<std::endl;
   ...
   //                //------------------------------------------
                  ...
                  ///*debug*/std::cout<<"phihit "<<phihit <<" phiwire1 "<<phiwire1 <<" _Dphi "<<_Dphi<<std::endl;
                  ...
                  ///*debug*/std::cout<<"Cirumscribed Cell Radius "<<itracker->getCellGeometryHandle()->GetCellRad()<<std::endl;
                  ///*debug*/std::cout<<"selected wire "<<ring<<" "<<wire<<std::endl;
