...
// ********************************************************************
//
// $Id: Mu2eEmStandardPhysics.cc 107183 2017-11-03 14:57:23Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   Mu2eEmStandardPhysics based on
//                G4EmStandardPhysics
//
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(Mu2eEmStandardPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

Mu2eEmStandardPhysics::Mu2eEmStandardPhysics(G4int ver, const G4String&)
  : G4VPhysicsConstructor("Mu2eEmStandard"), verbose(ver)
{
...
Mu2eEmStandardPhysics::~Mu2eEmStandardPhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void Mu2eEmStandardPhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void Mu2eEmStandardPhysics::ConstructProcess()
{
  if(verbose > 1) {
