...
class PBARVLongitudinalStringDecay 
   {
public:
            PBARVLongitudinalStringDecay();     
   virtual ~PBARVLongitudinalStringDecay();

private:
   // not implemented to protect/forbid use
   PBARVLongitudinalStringDecay(const PBARVLongitudinalStringDecay &right);
   const PBARVLongitudinalStringDecay & operator=(const PBARVLongitudinalStringDecay &right);
   int operator==(const PBARVLongitudinalStringDecay &right) const;
   int operator!=(const PBARVLongitudinalStringDecay &right) const;
