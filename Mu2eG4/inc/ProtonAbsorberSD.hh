#ifndef Mu2eG4_ProtonAbsorberSD_hh
#define Mu2eG4_ProtonAbsorberSD_hh
//
...
namespace mu2e {
  ...
  class ProtonAbsorberSD : public G4VSensitiveDetector{

  public:
    ProtonAbsorberSD(G4String, const SimpleConfig& config);
    ~ProtonAbsorberSD();
...
#endif /* Mu2eG4_ProtonAbsorberSD_hh */
