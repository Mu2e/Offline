...
#ifndef PBARLundStringFragmentation_h
#define PBARLundStringFragmentation_h 1

#include "Mu2eG4/inc/PBARVLongitudinalStringDecay.hh"

//**************************************************************************************************************

class PBARLundStringFragmentation: public PBARVLongitudinalStringDecay
    {
public:

    PBARLundStringFragmentation();
    virtual ~PBARLundStringFragmentation();

    virtual G4KineticTrackVector* FragmentString(const G4ExcitedString& theString);

private:
    // not implemented to protect/forbid use
    PBARLundStringFragmentation(const PBARLundStringFragmentation &right);
    const PBARLundStringFragmentation & operator=(const PBARLundStringFragmentation &right);
    int operator==(const PBARLundStringFragmentation &right) const;
    int operator!=(const PBARLundStringFragmentation &right) const;
