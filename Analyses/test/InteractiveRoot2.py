...
#
# $Id: InteractiveRoot2.py,v 1.3 2011/05/18 02:27:14 wb Exp $
# $Author: wb $
...
process.TFileService = mu2e.Service("TFileService",
                       fileName = mu2e.string("InteractiveRoot2.root"),
...
process.output = mu2e.EndPath(  process.root1*process.root2 );
