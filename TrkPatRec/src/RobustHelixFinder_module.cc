...
namespace mu2e
{
  ...
  void RobustHelixFinder::findHelices(const CaloClusterCollection* caloClusters,const StrawHitCollection& shcol, 
  ...
  void RobustHelixFinder::fitHelix(HelixSeed& hseed, const StereoHitCollection& sthcol,  
  ...
  void RobustHelixFinder::refitHelix(HelixSeed& hseed, const CaloClusterCollection* caloClusters)
  {
