// @(#)root/tmva $Id: TrainNonStereoHitsMVA.C,v 1.1 2014/04/07 22:50:31 brownd Exp $
/**********************************************************************************
...
void TrainNonStereoHitsMVA( TChain* inputChain=NULL)
{
...
//  }
  ...
  TString outfileName("tmva/TrainNonStereoHitsMVA.root");
  ...
  (TMVA::gConfig().GetIONames()).fWeightFileDir = "tmva/TrainNonStereoHitsMVA";

  // Define the input variables that shall be used for the MVA training
  // note that you may also use variable expressions, such as: "3*var1/var2*var3"
  ...
  */
  ...
  TCut signalCut = "pproc<20 && nchits>4 && ns>1 && nprimary/nchits>0.8 && (!_stereo) && _relation>=0 ";
  TCut backgrCut = "pproc<20 && nchits>4 && ns>1 && nprimary/nchits>0.8 && (!_stereo) && _relation<0";
