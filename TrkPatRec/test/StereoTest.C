...
//    dist->SetStats(0);
    ...
    sdpc0->SetLineColor(kRed);
    sdpd0->SetLineColor(kRed);
    ...
    sdpc4->SetLineColor(kCyan);
    sdpd4->SetLineColor(kCyan); 
    sdpc0->SetStats(0);

    sdrc0->SetLineColor(kRed);
    sdrd0->SetLineColor(kRed);
    sdrc1->SetLineColor(kBlack);
    sdrd1->SetLineColor(kBlack);
    sdrc2->SetLineColor(kBlue);
    sdrd2->SetLineColor(kBlue);
    sdrc3->SetLineColor(kGreen);
    sdrd3->SetLineColor(kGreen); 
    sdrc4->SetLineColor(kCyan);
    sdrd4->SetLineColor(kCyan); 
    sdrc0->SetStats(0);
...
//    sdrd1->SetStats(0);
    ...
    leg->AddEntry(sdpc0,"non-stereo","l");
    leg->AddEntry(sdpc1,"all stereo","l");
