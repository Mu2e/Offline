#ifndef DbTables_TrkAlignPanel_hh
#define DbTables_TrkAlignPanel_hh
...
namespace mu2e {
  ...
  class TrkAlignPanel : public DbTable {
  public:

    typedef std::shared_ptr<TrkAlignPanel> ptr_t;
    typedef std::shared_ptr<const TrkAlignPanel> cptr_t;
    ...
    TrkAlignPanel():DbTable("TrkAlignPanel","trk.alignpanel",
	 "index,dx,dy,dz,rx,ry,rz") {}
    const Row& rowAt(const std::size_t index) const { return _rows.at(index);}
    std::vector<Row> const& rows() const {return _rows;}
    std::size_t nrow() const { return _rows.size(); };
    virtual std::size_t nrowFix() const { return StrawId::_nupanels; };
