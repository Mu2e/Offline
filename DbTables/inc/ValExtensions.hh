...
class ValExtensions : public DbTable {
 public:
  class Row {
   public:
    Row(int eid, int vid, int extension, std::string create_time,
        std::string create_user) :
        _eid(eid),
        _vid(vid), _extension(extension), _create_time(create_time),
