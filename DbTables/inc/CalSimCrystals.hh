...
namespace mu2e {
  ...
  class CalSimCrystals : public DbTable {
    public:
      ...
      class Row {
        public:
          Row(CrystalId crid, float LRU, float pePerMeV_0, float pePerMeV_1, float ADCPerMeV_0, float ADCPerMeV_1):
            _crid(crid),
            _LRU(LRU),
            _pePerMeV_0(pePerMeV_0),
            _pePerMeV_1(pePerMeV_1),
            _ADCPerMeV_0(ADCPerMeV_0),
            _ADCPerMeV_1(ADCPerMeV_1)
          {}
          ...
          float      ADCPerMeV_0() const {return _ADCPerMeV_0;}
          float      ADCPerMeV_1() const {return _ADCPerMeV_1;}
      ...
      constexpr static const char* cxname = "CalSimCrystals";
      CalSimCrystals():DbTable(cxname,"cal.simcrystals","crid,LRU,pePerMeV0,pePerMeV1,ADCPerMeV0,ADCPerMeV1"){}
      ...
      void addRow(const std::vector<std::string>& columns) override {
        ...
        if (index != _rows.size() || index >= CaloConst::_nCrystal) {
          throw cet::exception("CALSIMCRYSTALS_BAD_INDEX")
          << "CalSimCrystals::addRow found index out of order: "
          <<index<< " != " << _rows.size() <<"\n";
        }
        _rows.emplace_back(CrystalId(index),std::stof(columns[1]),std::stof(columns[2]),
                           std::stof(columns[3]),std::stof(columns[4]),std::stof(columns[5]));
      }
      ...
      void rowToCsv(std::ostringstream& sstream, std::size_t irow) const override {
        ...
        sstream << r.ADCPerMeV_0()<<",";
        sstream << r.ADCPerMeV_1()<<"\n";
      }
