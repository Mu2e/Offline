...
namespace mu2e {
  ...
  class CalCosmicTimeCalib : public DbTable {
    ...
    CalCosmicTimeCalib():DbTable(cxname,"calocosmicstimecalib",
    ...
    void addRow(const std::vector<std::string>& columns) override {
      ...
      if(roid!=int(_rows.size())) {
        throw cet::exception("CaloCosmicsTimeCalib_BAD_INDEX")
        << "CaloCosmicsTimeTable::addRow found index out of order: "
