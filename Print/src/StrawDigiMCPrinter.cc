...
void mu2e::StrawDigiMCPrinter::Print(art::Event const& event,
                                     std::ostream& os) {
  if (verbose() < 1) return;
  if (tags().empty()) {
    // if a list of instances not specified, print all instances
    std::vector<art::Handle<StrawDigiMCCollection> > vah =
        event.getMany<StrawDigiMCCollection>();
...
void mu2e::StrawDigiMCPrinter::Print(
    const art::Handle<StrawDigiMCCollection>& handle, std::ostream& os) {
  if (verbose() < 1) return;
...
void mu2e::StrawDigiMCPrinter::Print(
    const art::ValidHandle<StrawDigiMCCollection>& handle, std::ostream& os) {
  if (verbose() < 1) return;
  // the product tags with all four fields, with underscores
  std::string tag = handle.provenance()->productDescription().branchName();
  tag.pop_back();  // remove trailing dot
...
void mu2e::StrawDigiMCPrinter::Print(const StrawDigiMCCollection& coll,
                                     std::ostream& os) {
  if (verbose() < 1) return;
...
void mu2e::StrawDigiMCPrinter::Print(const art::Ptr<StrawDigiMC>& obj, int ind,
                                     std::ostream& os) {
  if (verbose() < 1) return;
  Print(*obj, ind);
}

void mu2e::StrawDigiMCPrinter::Print(const mu2e::StrawDigiMC& obj, int ind,
                                     std::ostream& os) {
  if (verbose() < 1) return;
  ...
  if (verbose() == 1) {
    os << " " << std::setw(5) << obj.strawId().asUint16() << " "
       ...
       << obj.wireEndTime(StrawEnd::cal) << " " << std::setw(8)
       << std::setprecision(2) << obj.wireEndTime(StrawEnd::hv) << " "
       << std::setw(8) << std::setprecision(4) << energy << " " << std::setw(6)
       << obj.isCrossTalk(StrawEnd::cal) << " " << std::setw(6)
       << obj.isCrossTalk(StrawEnd::hv) << " ";
    os << std::endl;
  } else if (verbose() == 2) {
    os << " index :" << std::setw(5) << obj.strawId().asUint16() << " "
       << " time0: " << std::setw(8) << std::setprecision(2)
       << obj.wireEndTime(StrawEnd::cal) << " time1: " << std::setw(8)
       << std::setprecision(2) << obj.wireEndTime(StrawEnd::hv) << " ";
    os << std::endl;
    os << " trigEnergy0: " << std::setw(8) << std::setprecision(4) << tenergy0
       << " trigEnergy1: " << std::setw(8) << std::setprecision(4) << tenergy1
    ...
    os << " position0: " << std::setw(10) << std::setprecision(4) << v0.x()
       << std::setw(10) << std::setprecision(4) << v0.y() << std::setw(10)
       << std::setprecision(4) << v0.z() << std::setw(10)
       << std::setprecision(4) << v0.t() << " ";
    os << std::endl;
    CLHEP::HepLorentzVector const& v1 = obj.clusterPosition(StrawEnd::hv);
    os << " position1: " << std::setw(10) << std::setprecision(4) << v1.x()
       << std::setw(10) << std::setprecision(4) << v1.y() << std::setw(10)
       << std::setprecision(4) << v1.z() << std::setw(10)
       << std::setprecision(4) << v1.t() << " ";
    os << std::endl;
    ...
    if (!a0.isAvailable()) {
      ...
      os << " StepPointMC_0: "
         ...
         << "   energy: " << std::setw(8) << std::setprecision(6) << a0->eDep()
    ...
    if (!a1.isAvailable()) {
      ...
      os << " StepPointMC_1: "
         ...
         << "   energy: " << std::setw(8) << std::setprecision(4) << a1->eDep()
         << "   SimParticle: " << std::setw(5) << isim;
      os << std::endl;
    }
  }  // verbose=2
...
void mu2e::StrawDigiMCPrinter::PrintHeader(const std::string& tag,
                                           std::ostream& os) {
  if (verbose() < 1) return;
  os << "\nProductPrint " << tag << "\n";
}

void mu2e::StrawDigiMCPrinter::PrintListHeader(std::ostream& os) {
  if (verbose() < 1) return;
  os << " ind StrwInd   time0   time1    drift0   drift1   energy    "
        "crossTalk\n";
}
