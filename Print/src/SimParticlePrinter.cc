...
void mu2e::SimParticlePrinter::Print(const mu2e::SimParticle& obj, int ind,
  ...
  if (verbose() == 1) {
    os << " " << std::setw(7)  << key
       ...
       << " " << std::setw(8)  << std::setprecision(3) << obj.startPosition().x()
       << " " << std::setw(8)  << std::setprecision(3) << obj.startPosition().y()
       << " " << std::setw(8)  << std::setprecision(3) << obj.startPosition().z()
       << " " << std::setw(9)  << std::setprecision(3) << obj.startMomentum().vect().mag()
       << " " << std::setw(9)  << std::setprecision(3) << obj.startMomentum().vect().perp()
       << " " << std::setw(8)  << std::setprecision(3) << obj.startGlobalTime()
       << "   "
       << " " << std::setw(8)  << std::setprecision(3) << obj.endPosition().x()
       << " " << std::setw(8)  << std::setprecision(3) << obj.endPosition().y()
       << " " << std::setw(8)  << std::setprecision(3) << obj.endPosition().z()
       << " " << std::setw(9)  << std::setprecision(3) << obj.endMomentum().vect().mag()
       << " " << std::setw(9)  << std::setprecision(3) << obj.endMomentum().vect().perp()
       << " " << std::setw(8)  << std::setprecision(3) << obj.endGlobalTime()
