...
mu2e::SimParticlePrinter::Print(const mu2e::SimParticle& obj, 
  ...
  if(verbose()==1) {
    os 
     ...
     os
      << "  Start  gtime: " << std::setw(8) << std::setprecision(1) << obj.startGlobalTime()
      << "  ptime: " << std::setw(8) << std::setprecision(1) << obj.startProperTime()
     ...
     os
       ...
       << " " << std::setw(8) << std::setprecision(1) << obj.startPosition().y()
       << " " << std::setw(8) << std::setprecision(1) << obj.startPosition().z()
       << "  mom: " << std::setw(8) << std::setprecision(1) << obj.startMomentum().x()
       << " " << std::setw(8) << std::setprecision(1) << obj.startMomentum().y()
       << " " << std::setw(8) << std::setprecision(1) << obj.startMomentum().z() << "\n";
     os
      << "  End  gtime: " << std::setw(8) << std::setprecision(1) << obj.endGlobalTime()
      << "  ptime: " << std::setw(8) << std::setprecision(1) << obj.endProperTime()
      << "  volIdx: " << std::setw(4) << obj.endVolumeIndex()
      << "  g4status: " << std::setw(4) << obj.endG4Status() << "\n";
     os
       << "  End  stopCode: " << std::setiosflags(std::ios::left) << obj.stoppingCode().name()
      << "  stepKE: " << std::setw(8) << std::setprecision(1) << obj.preLastStepKineticEnergy()
      << "  nStep: " << std::setw(4) << obj.nSteps() << "\n";
     os
       << "  End pos: " << std::setw(8) << std::setprecision(1) << obj.endPosition().x()
       << " " << std::setw(8) << std::setprecision(1) << obj.endPosition().y()
       << " " << std::setw(8) << std::setprecision(1) << obj.endPosition().z()
       << "  mom: " << std::setw(8) << std::setprecision(1) << obj.endMomentum().x()
       << " " << std::setw(8) << std::setprecision(1) << obj.endMomentum().y()
       << " " << std::setw(8) << std::setprecision(1) << obj.endMomentum().z() << "\n";
