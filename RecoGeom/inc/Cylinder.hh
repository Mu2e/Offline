  ...
  namespace RecoGeom {
    class Cylinder : public Surface {
      public:
        ...
        Cylinder(XYZVectorD const& axis, XYZVectorD const& center, double halflen, double radius) : axis_(axis), center_(center), halflen_(halflen), radius_(radius), radius2_(radius*radius) {}
        // surface interface
