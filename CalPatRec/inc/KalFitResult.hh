...
// must initialize with a TrkDefHack
    KalFitResult(TrkDefHack const* tdef) : _tdef(tdef) ,_krep(0), _fit(TrkErrCode::fail), _nt0iter(0), _nweediter(0), _nunweediter(0), _ninter(0) {
