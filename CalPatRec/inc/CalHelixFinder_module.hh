...
//-----------------------------------------------------------------------------
  public:
    ...
    struct Config {
      ...
      fhicl::Table<fhicl::ParameterSet> helixFinderAlg{ Name("HelixFinderAlg"),
	  Comment("HelixFinderAlg configuration")};
      // fhicl::Sequence<int> helicities{ Name("Helicities"), [Helicity::neghel, Helicity::poshel],
      // 	  Comment("Helicities used for the pattern recognition")};
      fhicl::Table<fhicl::ParameterSet> timeOffsets{ Name("TimeOffsets"),
