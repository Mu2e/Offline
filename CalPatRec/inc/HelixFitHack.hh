...
//
// $Id: HelixFitHack.hh,v 1.5 2014/04/04 21:23:34 murat Exp $
// $Author: murat $ 
...
// note that dfdz has a physical ambiguity in q*zdir.
    ...
    HelixFitHackResult(HelixDefHack const& hdef) : _hdef(hdef),  _fit(TrkErrCode::fail),_radius(-1.0),_dfdz(0.0),_fz0(0.0) {}
