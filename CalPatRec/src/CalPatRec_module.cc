...
// 					50000, 0., 5000.);
    ...
    _hist._NpointsRescued [1]  = tfs->make<TH1F>("hnprescued_1","fraction of points rescued [1] for cut set C track and p>100 MeV/c; np_{rescued}/np_{tot}", 100, 0., 1);
