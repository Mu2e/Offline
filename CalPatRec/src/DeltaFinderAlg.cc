...
//-----------------------------------------------------------------------------
// same as 'connectSeeds()', but the process moves upstream
//-----------------------------------------------------------------------------
  void DeltaFinderAlg::connectSeeds_2() {
...
//-----------------------------------------------------------------------------
            ...
            double res_x = x1-wx1*wd1;
            double res_y = y1-wy1*wd1;
...
//-----------------------------------------------------------------------------
    ...
    std::sort(_data->_v.begin(), _data->_v.end(), DeltaFinderAlg::less);
//-----------------------------------------------------------------------------
